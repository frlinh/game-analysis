...
//       var championid = data.id;
  
//       championid.forEach((id) => {
//         selector
//           .append("option")
//           .text(id)
//           .property("value", name);
...
//       var firstChampion = championid[0];
...
//       var resultArray = stats.filter(statsObj => statsObj.id == id);
//       var result = resultArray[0];
//       // Use d3 to select the panel with id of `#stats-metadata`
//       var PANEL = d3.select("#stats-metadata");
